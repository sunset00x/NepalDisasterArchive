...
<a href="<?=BASE_URL?>/admin/index.php">Dashboard</a><?php if($me['role']==='ADMIN'):?><a href="<?=BASE_URL?>/admin/analytics.php">Analytics</a><?php endif;?><a href="<?=BASE_URL?>/admin/stories.php">Stories</a><a href="<?=BASE_URL?>/admin/bulk-locations.php">Bulk Locations</a><?php if($me['role']==='ADMIN'):?><a href="<?=BASE_URL?>/admin/corrections.php">Corrections</a><a href="<?=BASE_URL?>/admin/human-submissions.php">Human Submissions</a><a href="<?=BASE_URL?>/admin/volunteers.php">Volunteer Network</a><?php endif;?><a href="<?=BASE_URL?>/admin/story-edit.php">New Story</a><a href="<?=BASE_URL?>/admin/categories.php">Categories</a><a href="<?=BASE_URL?>/admin/users.php">Users</a>
